...
from app.api.v1 import inventory, statistics
from app.api.v1 import rentalos
...
app.include_router(rentalos.router, prefix="/api/v1")
...
async def startup_event():
    """Verify database connection on startup and start keep-alive task"""
    try:
        db = SessionLocal()
