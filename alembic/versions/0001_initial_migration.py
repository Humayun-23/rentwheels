...
def upgrade() -> None:
    ...
    op.create_index('ix_bikes_id',      'bikes', ['id'],      unique=False)
    op.create_index('ix_bikes_shop_id', 'bikes', ['shop_id'], unique=False)
    ...
    op.create_table(
        ...
        sa.Column('rented_quantity',    sa.Integer(),  nullable=False, server_default='0'),
        sa.Column('created_at',         sa.DateTime(), nullable=True),
        sa.Column('updated_at',         sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(['bike_id'], ['bikes.id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['shop_id'], ['shops.id'], ondelete='CASCADE'),
    ...
    op.create_index('ix_bike_inventory_id',      'bike_inventory', ['id'],      unique=False)
    op.create_index('ix_bike_inventory_bike_id', 'bike_inventory', ['bike_id'], unique=False)
    op.create_index('ix_bike_inventory_shop_id', 'bike_inventory', ['shop_id'], unique=False)
    ...
    op.create_index('ix_bookings_bike_id',     'bookings', ['bike_id'],     unique=False)
    ...
    op.create_index('ix_reviews_shop_id',     'reviews', ['shop_id'],     unique=False)
    ...
    op.create_index('ix_payment_order_id',   'payment', ['order_id'],   unique=True)
    op.create_index('ix_payment_payment_id', 'payment', ['payment_id'], unique=True)
    op.create_index('ix_payment_booking_id', 'payment', ['booking_id'], unique=False)
